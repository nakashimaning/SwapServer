...
@WebServlet("/api/registered-wishitems")
public class GetRegisteredWishItemsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        try {//取得我申請的WISHITEM
            WishItemListSectionDao wishItemDao = new WishItemListSectionDao();
            List<WishItemListSection> wishItems = wishItemDao.getWishItemsByRegistrantUserId(currentUserId);

            // Convert the list to JSON and write to response
            String json = gson.toJson(wishItems);
